...
public interface MusicStorageServerAPI {
     ...
     *         false - otherwise
     */
    boolean createMusicItem(
            String musicItemIdentifier,
            InputStream musicItemStream,
            String metaData,
     ...
     *         list passed
     */
    String[] readMusicItemMetaData(
            String[] musicItemIdentifiers,
            ReadResponse response);
     ...
     */
    boolean
        deleteMusicItem(String musicItemIdentifier, DeleteResponse response);
